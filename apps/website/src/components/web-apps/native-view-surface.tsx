// NativeViewSurface — the live-view analog of WebviewSurface. Where
...
// own its geometry.
//
// Lifecycle: onMount → native-surface-host.track(surfaceId, el); onCleanup →
...
export function NativeViewSurface(props: { surfaceId: number }) {
  let placeholder!: HTMLDivElement;

  onMount(() => {
    nativeSurfaceHost.track(props.surfaceId, placeholder);
  });

  onCleanup(() => {
    nativeSurfaceHost.untrack(props.surfaceId, placeholder);
  });
